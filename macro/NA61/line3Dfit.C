...
Int_t line3Dfit() {
    ...
    gr->SetPoint(0, -51.1284, -28.7743, 647.85);
    gr->SetPoint(1, -51.8181, -26.8742, 688.444);
    gr->SetPoint(2, -51.8183, -26.6557, 692.395);
    gr->SetPoint(3, -51.7247, -27.0042, 684.495);
    ...
    int n = 100;
    double t0 = gr->GetZmin();

    double dt = (gr->GetZmax() - t0);
    cout << "dt = " << dt << endl;
